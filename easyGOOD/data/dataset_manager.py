...
def load_dataset(name: str, config: Union[CommonArgs, Munch]) -> dir:
    ...
    try:
        ...
        print(f'Dataset description: data={config.dataset.dataset_name}, domain={config.dataset.domain}, shift={config.dataset.shift_type}, generate={config.dataset.generate}')
